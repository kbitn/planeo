...
ActiveRecord::Schema.define(version: 2019_11_27_132925) do
  ...
  create_table "usergroups", force: :cascade do |t|
    ...
    t.index ["user_id", "group_id"], name: "index_usergroups_on_user_id_and_group_id", unique: true
  ...
  add_foreign_key "groups", "users", column: "administrator_id"
